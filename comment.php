        ...
        <div class="row">
            ...
            while($row = $result->fetch_assoc()) {
                ...
                <?php
                    ...
                    <td bgcolor='#eb8934' align='right'>
                    <a style="color: Black;" href="validation-form/replySubComment.php?id=<?=$row_reply["id_reply"]?>">Ответить</a></td><tr>
                ...
                ?>
                    ...
                    <td bgcolor='#eb8934' align='right'>
                    <a style="color: Black;"  href="validation-form/editSubComment.php?editSubComment=<?=$rowSubComment["id_reply"]?>">Редактировать</a>
                    <a style="color: Black;"  href="validation-form/deleteSubComment.php?idDeleteSubComment=<?=$rowSubComment["id_reply"]?>">Удалить</a></td><tr>
