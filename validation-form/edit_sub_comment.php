    ...
    <div class="container mt-4">
        ...
        <div class="row">
            <div class="col" align="center">
                ...
                <form action="check_edit_sub_comment.php?idEditSubComment=<?=$editSubComment?>" method="post">
                <div class="mb-3">
    ...
    //Имя пользователя который оставил комментарий
        ...
        if ($result_reply->num_rows > 0) {
            ...
            if ($row_reply['id_comment'] == $row["id"]){?>
                ...
                <?php if ($editSubComment == $rowSubComment["id_reply"]){ ?>
