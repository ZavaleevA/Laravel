            ...
            @foreach($data as $comment)
                <div class="alert alert-info">
                    ...
                    <table border="0" width="100%" cellpadding="7">
                        ...
                        <a style="color: Black;" class="btn btn-warning" href="{{route('comment-data')}}">Отмена</a></td><tr>
                        </table>
                </div>
            @endforeach
        </div>    
        <div class="col-md-8">    
            <div class="card">
                <div class="card-body"  align="center">
                    ...
                    <form action="{{ route('add-sub-comment', $comment->id) }}" method="POST">
                        @csrf
                        ...
                        <a href="{{route('comment-data')}}" class="btn btn-info" >Назад</a>
                    </form>  
                </div>
            </div>
        </div>
