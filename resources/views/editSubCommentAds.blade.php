        ...
        <div class="col-md-8">
            ...
            <div class="card">
                <div class="card-body"  align="center">
                    ...
                    @foreach($data as $el)
                    <form action="{{ route('edit-sub-comment-ads', $el->id) }}" method="POST">
                        @csrf
                        ...
                        <a href="{{route('date-ads', DB::table('comment_ads')->where('id', $el->id_comment)->value('ads_id'))}}" class="btn btn-info" >Назад</a>
                    </form>  
                    @endforeach
                </div>
            </div>
